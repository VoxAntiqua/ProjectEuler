# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 16:51:53 2019
...
for m in range(16):
    for n in range(20):
        producttest = numbers[m][n]*numbers[m+1][n]*numbers[m+2][n]*numbers[m+3][n]
        if producttest > maxproduct:
            maxproduct = producttest
            
#test horizontal products
for m in range(20):
    for n in range(16):
        producttest = numbers[m][n]*numbers[m][n+1]*numbers[m][n+2]*numbers[m][n+3]
        if producttest > maxproduct:
            maxproduct = producttest
             
#test diagonal products
for m in range(16):
    for n in range(16):
        producttest = numbers[m][n]*numbers[m+1][n+1]*numbers[m+2][n+2]*numbers[m+3][n+3]
        if producttest > maxproduct:
            maxproduct = producttest
            
#test other diagonal products
for m in range(3,20):
    for n in range(16):
        producttest = numbers[m][n]*numbers[m-1][n+1]*numbers[m-2][n+2]*numbers[m-3][n+3]
        if producttest > maxproduct:
